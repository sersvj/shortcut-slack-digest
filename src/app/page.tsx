...
function DashboardInner() {
  ...
  return (
    <div suppressHydrationWarning className={`flex flex-col ${isMobile ? 'min-h-screen' : 'h-screen overflow-hidden'} bg-[var(--color-surface-base)] relative`}>
      {/* Header */}
