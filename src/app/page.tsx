...
export default function DashboardPage() {
  ...
  return (
    <div className="flex flex-col h-screen overflow-hidden bg-[var(--color-surface-base)]">
      {/* Header */}
      <header className="sticky top-0 z-50 bg-[var(--color-surface-1)]/90 backdrop-blur-md border-b border-[var(--color-border)]">
        {/* Top Bar: Logo & User */}
        <div className="flex items-center justify-between px-6 h-14 border-b border-[var(--color-border)]/50">
          ...
          {loadingGroups ? (
            <div className="grid grid-cols-2 gap-6 h-full">
              {[0, 1].map((col) => (
                <div key={col} className="flex flex-col h-full overflow-hidden">
                  ...
                  <div className="flex-1 overflow-y-auto pr-2 space-y-3 mt-3">
                    {[1, 2, 3].map((i) => (
            ...
            <div className="grid grid-cols-2 gap-8 h-full">
              ...
              <div className="flex flex-col h-full overflow-hidden">
                ...
                <div className="flex-1 overflow-y-auto pr-3 mt-4 pb-8 custom-scrollbar">
              ...
              {/* Inactive */}
              <div className="flex flex-col h-full overflow-hidden border-l border-[var(--color-border)]/30 pl-8">
